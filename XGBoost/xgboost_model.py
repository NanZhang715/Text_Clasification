...
del sql_train, sql_test, train_data, test_data
...
parameters = {
    ...
    'tfidf__norm': ('l1', 'l2'),
    'clf__reg_alpha': (0.5,1),
    'clf__reg_lambda': (0.5,1)
#    'clf__alpha':(0.5,1),        # L1 regularization
...
if __name__ == "__main__":
    ...
    grid_search = GridSearchCV(pipeline, parameters, cv=5,
                               n_jobs=-1, verbose=1)  # n_jobs: 使用所有线程
    ...
    XGBoost_model = pickle.dumps(grid_search)
